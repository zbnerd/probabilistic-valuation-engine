...
| ADR-006: Redis Lock Lease Timeout | [docs/01_ADR/ADR-006-redis-lock (ARCHIVED: docs/_archive/redis-deprecated/).md](docs/01_ADR/ADR-006-redis-lock (ARCHIVED: docs/_archive/redis-deprecated/).md) |
