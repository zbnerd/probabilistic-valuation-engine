...
**10,994 RPS. 에러 0개.** 97 RPS 대비 **113배 향상**.

500 연결에서 **10,994 RPS**를 달성했다. 200 연결에서도 7,347 RPS로 안정적인 성능을 보였다. 하지만 이 수치는 모두 빈 DB 환경에서의 측정이었다.
