# Like Domain Refactoring Journey — 좋아요, 133일간의 진화
...
이 문서는 **Probabilistic Valuation Engine**의 **Like(좋아요) 도메인**이 2025년 11월부터 2026년 3월까지 133일간 겪은 리팩토링 여정을 담습니다.
...
| 지표 | 값 |
|------|-----|
| 총 기간 | 133일 (2025.11.28 ~ 2026.03.31) |
| Like 관련 커밋 | 80+ |
| Like 관련 PR | 30+ |
| Like 관련 이슈 | 20+ |
| ADR 문서 | 6개 |
| P0 해결 | 12건 |
| P1 해결 | 19건 |
| DB QPS | 3,500/s → <200/s (17x 감소) |
| P99 Latency | 35ms → 8ms (4x 개선) |
