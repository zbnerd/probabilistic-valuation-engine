...
PRIMARY = {
    ...
    "module-calculator/src/main/kotlin/maple/calculator/consumer/SnapshotDispatchService.kt": ("현재 코드", "dispatch 성공 뒤 수동 ACK"),
    "module-calculator/src/main/kotlin/maple/calculator/processor/SnapshotChunkProcessor.kt": ("현재 코드", "스트리밍 처리"),
    "module-calculator/src/main/kotlin/maple/calculator/writer/CalculationResultWriter.kt": ("현재 코드", "임시 파일·비동기 업로드"),
...
- 이 상세 파일 카탈로그의 기준은 로컬 작업트리 HEAD `{head}`다.
