...
- Issue #77 resolution: Redis Failover stability improvements validated (Evidence: [ADR-006](../01_ADR/ADR-006-redis-lock (ARCHIVED: docs/_archive/redis-deprecated/).md))
...
> **Fix Validated:** ReadMode.MASTER + 1s scanInterval eliminated all READONLY errors (Evidence: [ADR-006](../01_ADR/ADR-006-redis-lock (ARCHIVED: docs/_archive/redis-deprecated/).md)).
...
- **ADR-006:** `docs/01_Adr/ADR-006-redis-lock (ARCHIVED: docs/_archive/redis-deprecated/).md` (Sentinel HA decision)
