 ...
 */
data class CharacterLikeDto(var targetOcid: String? = null, var likerAccountId: String? = null) : BaseDto() {

    var id: Long? = null

    companion object {
        @JvmStatic
        fun from(entity: CharacterLike): CharacterLikeDto = CharacterLikeDto(
        ...
        @JvmStatic
        fun forCreation(targetOcid: String, likerAccountId: String): CharacterLikeDto = CharacterLikeDto(
    ...
    fun toEntity(): CharacterLike = CharacterLike(
        id,
    ...
    fun isSelfLike(userCharacterOcids: List<String>?): Boolean = userCharacterOcids != null && userCharacterOcids.contains(targetOcid)
