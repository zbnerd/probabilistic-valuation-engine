...
class CacheConfig {
     ...
     * </ul>
     */
    private fun resolveSerializer(type: String): RedisSerializer<*> = if ("jdk".equals(type, ignoreCase = true)) {
    ...
    fun expectationL2CacheManager(
        connectionFactory: RedisConnectionFactory,
        @Qualifier("expectationCacheSerializer") serializer: RedisSerializer<Any>,
    ): CacheManager {
        val config =
            RedisCacheConfiguration.defaultCacheConfig()
