 ...
 *
 * @see maple.expectation.infrastructure.config.PerCacheExecutorConfig PER 전용 Executor (DiscardPolicy)
 */
@Configuration
...
class EquipmentProcessingExecutorConfig(
     ...
     */
    @Bean(name = ["equipmentProcessingExecutor"])
    fun equipmentProcessingExecutor(contextPropagatingDecorator: TaskDecorator): Executor {
