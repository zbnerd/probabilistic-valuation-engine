...
class LikeRealtimeSyncConfig {
    ...
    class RTopicConfig(
        ...
        fun likeEventPublisher(): LikeEventPublisher {
            ...
            return RedisLikeEventPublisher(redissonClient, executor, meterRegistry)
        }
        ...
        fun likeEventSubscriber(): LikeEventSubscriber {
            ...
            return RedisLikeEventSubscriber(redissonClient, cacheManager, executor, meterRegistry)
        }
    }
    ...
    class ReliableTopicConfig(
        ...
        fun likeEventPublisher(): LikeEventPublisher {
            ...
            return ReliableRedisLikeEventPublisher(redissonClient, executor, meterRegistry)
        }

        @Bean
        fun likeEventSubscriber(): LikeEventSubscriber {
            log.info("[LikeRealtimeSyncConfig] Creating RReliableTopic LikeEventSubscriber bean (at-least-once)")
            return ReliableRedisLikeEventSubscriber(redissonClient, cacheManager, executor, meterRegistry)
        }
    }
}
