...
@TestPropertySource(
    properties = [
        ...
        "storage.minio.access-key=calculator",
        "storage.minio.secret-key=\${SA_CALCULATOR_SECRET_KEY}",
    ],
)
@ComponentScan(
...
class CalculatorBootSmokeIT {

    @Autowired
    private lateinit var healthIndicator: ArtifactStorageHealthIndicator

    @Test
    fun `calculator boots and bucket validates`() {
