...
class JdbcOcidQueryAdapter(
    ...
    override fun resolveOcid(userIgn: String): String? = jdbc.queryForList(
        "SELECT ocid FROM game_character WHERE user_ign = :userIgn LIMIT 1",
        mapOf("userIgn" to userIgn),
        String::class.java,
    ).firstOrNull()

    override fun resolveOcids(userIgns: Set<String>): Map<String, String> = jdbc.queryForList(
    ...
    override fun resolveAllOcids(): Map<String, String> = jdbc.queryForList(
    ...
    override fun resolveOcidsByFingerprint(fingerprint: String): Set<String> = jdbc.queryForList(
        "SELECT ocid FROM game_character WHERE fingerprint = :fingerprint AND ocid IS NOT NULL",
        mapOf("fingerprint" to fingerprint),
        String::class.java,
    ).toSet()

    override fun updateFingerprint(ocid: String, fingerprint: String, accountId: String): Int = jdbc.update(
